...
public class ConsumeItems extends javax.swing.JPanel {
    ...
    private void initComponents() {
         ...
         menuItemComboBox = new javax.swing.JComboBox<String>();
         ...
         jLabel3.setText("Consusuption per week(Kgs/Ltrs)   ");

         jLabel1.setText("Choose Menu Item                          ");

         menuItemComboBox.setModel(new javax.swing.DefaultComboBoxModel<String>(new String[] { "Vegetables", "Fruits", "Dry Items", "Others" }));
...
private void OKButtonActionPerformed(java.awt.event.ActionEvent evt) 
{
    ...
    if(itemNameText.equals("") ||itemNameText.equals("") )
    {
	...
	if(null !=menuItemMap)
	{
		if(menuItemMap.containsKey(itemNameText))
		{
			Double qty = menuItemMap.get(itemNameText);
			Double qty1=qty-(Double.valueOf(consumeItemText));
			if(qty1<0)
			{
				JOptionPane.showMessageDialog(null, "The list contains only "+qty+" kgs/ltrs of "+itemNameText, "Error", 2);
				consumptionTextField.setText("");
				return;
			}
			menuItemMap.put(itemNameText, qty1);
			JOptionPane.showMessageDialog(null, "The Item Name '"+itemNameText+"' is suceesfully updated.", "Successfully", 1);
			itemNameTextField.setText("");
			consumptionTextField.setText("");
		}
		else
		{
			JOptionPane.showMessageDialog(null, "The Item Name '"+itemNameText+"' is not in the List.", "Error", 2);
			itemNameTextField.setText("");
			return;
		}
	}
...
private void menuItemComboBoxActionPerformed(java.awt.event.ActionEvent evt) 
{
