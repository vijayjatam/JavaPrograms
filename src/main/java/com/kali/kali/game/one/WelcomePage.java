...
import com.kali.game.one.MindGame;
...
public class WelcomePage extends JFrame {
	...
	com.kali.game.one.MindGame mindGameObj = new MindGame();
	...
	public static void validateUserName() {
		try {
			...
			if (userName != null && !userName.trim().equalsIgnoreCase("")) {
				...
				KEY_VALUE = com.kali.game.one.UtilClass.getExistedDataFromFile(new File("src/main/java/com/kali/game/one/score.txt"));
