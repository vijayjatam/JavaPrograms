...
import com.kali.schElectric.Person;
...
public class MainClass {
	public static void main(String[] args) {
		...
		com.kali.schElectric.Person person_1 = new com.kali.schElectric.Person(reservation);
		person_1.setName("kali");
		person_1.setAge(22);
		person_1.setHowmanySeats(5);
		Thread thread_1 = new Thread(person_1);

		com.kali.schElectric.Person person_2 = new com.kali.schElectric.Person(reservation);
		person_2.setName("Mahan");
		person_2.setAge(23);
		person_2.setHowmanySeats(4);
		Thread thread_2 = new Thread(person_2);

		com.kali.schElectric.Person person_3 = new com.kali.schElectric.Person(reservation);
		person_3.setName("Mahankali");
		person_3.setAge(24);
		person_3.setHowmanySeats(3);
		Thread thread_3 = new Thread(person_3);

		com.kali.schElectric.Person person_4 = new com.kali.schElectric.Person(reservation);
		person_4.setName("Venky");
		person_4.setAge(24);
		person_4.setHowmanySeats(3);
		Thread thread_4 = new Thread(person_4);

		com.kali.schElectric.Person person_5 = new com.kali.schElectric.Person(reservation);
		person_5.setName("Sowjanya");
		person_5.setAge(24);
		person_5.setHowmanySeats(3);
		Thread thread_5 = new Thread(person_5);

		com.kali.schElectric.Person person_6 = new com.kali.schElectric.Person(reservation);
		person_6.setName("Thottigadu");
		person_6.setAge(24);
		person_6.setHowmanySeats(4);
		Thread thread_6 = new Thread(person_6);

		com.kali.schElectric.Person person_7 = new com.kali.schElectric.Person(reservation);
		person_7.setName("person_7");
		person_7.setAge(24);
		person_7.setHowmanySeats(3);
		Thread thread_7 = new Thread(person_7);

		com.kali.schElectric.Person person_8 = new Person(reservation);
