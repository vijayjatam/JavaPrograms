...
class StringOperation_Test {
	...
	public static void test(){
		HashMap<Integer, com.kali.TestingBean> map =new HashMap();
		com.kali.TestingBean t1 = new com.kali.TestingBean();
		Byte b = (byte) -129;
		com.kali.TestingBean t2 = new com.kali.TestingBean();
		t2.setIntr(4);
		com.kali.TestingBean t3 = new com.kali.TestingBean();
		t3.setDoubl(10.23);
		com.kali.TestingBean t4 = new com.kali.TestingBean();
		t4.setStr("54");
		map.put(1, t1);
		map.put(2, t2);
		map.put(3, t3);
		...
		for(Map.Entry<Integer, com.kali.TestingBean> tb : map.entrySet()){
